...
@SpringBootTest
public class PandaUsersApplicationTests {
...
//            Credential cred = new Credential("AKID97BAv0MHTO5duussZiRM6rLXLCm4rt3w", "mJhodDWmlSvFguudGchdWGkzzxiDIrQk");
//
//            /* 实例化 SMS 的 client 对象
...
//            String templateID = "1302690271";
//            req.setTemplateID(templateID);
//
//            /* 下发手机号码，采用 e.164 标准，+[国家或地区码][手机号]
//             * 例如+8613711112222， 其中前面有一个+号 ，86为国家码，13711112222为手机号，最多不要超过200个手机号*/
//            String[] phoneNumbers = {"+8618770544902"};
...
//        request.putQueryParameter("SignName", "飞鸽证券");
